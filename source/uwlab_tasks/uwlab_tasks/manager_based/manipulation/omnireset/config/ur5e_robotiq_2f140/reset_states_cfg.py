...
@configclass
class UR5eRobotiq2f140ResetStatesCfg(ManagerBasedRLEnvCfg):
    """Configuration for reset states environment with UR5e Robotiq 2F140 gripper."""
...
@configclass
class ObjectRestingEEGraspedResetStatesCfg(UR5eRobotiq2f140ResetStatesCfg):
...
@configclass
class ObjectAnywhereEEGraspedResetStatesCfg(UR5eRobotiq2f140ResetStatesCfg):
...
@configclass
class ObjectPartiallyAssembledEEAnywhereResetStatesCfg(UR5eRobotiq2f140ResetStatesCfg):
