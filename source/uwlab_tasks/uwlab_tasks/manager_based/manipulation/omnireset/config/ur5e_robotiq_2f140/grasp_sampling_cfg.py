...
class GraspSamplingSceneCfg(InteractiveSceneCfg):
    ...
    robot = ur5e_robotiq_gripper.ROBOTIQ_2F140.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class Robotiq2f140GraspSamplingCfg(ManagerBasedRLEnvCfg):
    """Configuration for grasp sampling environment with Robotiq 2F140 gripper."""
    ...
    actions: ur5e_robotiq_gripper.Robotiq2f140BinaryGripperAction = ur5e_robotiq_gripper.Robotiq2f140BinaryGripperAction()
