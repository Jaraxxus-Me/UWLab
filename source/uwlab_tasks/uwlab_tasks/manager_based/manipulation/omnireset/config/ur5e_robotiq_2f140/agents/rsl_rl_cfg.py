...
class Base_PPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    save_interval = 100
    resume = False
    experiment_name = "ur5e_robotiq_2f140_omnireset_agent"
    ...
    algorithm = RslRlFancyPpoAlgorithmCfg(
        ...
        offline_algorithm_cfg=OffPolicyAlgorithmCfg(
            behavior_cloning_cfg=BehaviorCloningCfg(
                ...
                experts_observation_group_cfg="uwlab_tasks.manager_based.manipulation.omnireset.config.ur5e_robotiq_2f140.rl_state_cfg:ObservationsCfg.PolicyCfg",
                experts_observation_func=my_experts_observation_func,
                experts_action_group_cfg="uwlab_tasks.manager_based.manipulation.omnireset.config.ur5e_robotiq_2f140.actions:Ur5eRobotiq2f140RelativeOSCAction",
