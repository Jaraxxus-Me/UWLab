...
# articulation exposes 17 rigid bodies (one extra ``base_link_inertia``);
# we exclude it so body-count-dependent observations (mass, material props)
# have the same shape as the 2F-85 task.
_OBS_BODY_NAMES_2F140 = [
    "base_link",
    "shoulder_link",
    "upper_arm_link",
    "forearm_link",
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        joint_pos = ObsTerm(
            ...
            params={"asset_cfg": SceneEntityCfg("robot", joint_names=_OBS_JOINT_NAMES_2F140)},
        )
    ...
    class CriticCfg(ObsGroup):
        ...
        robot_material_properties = ObsTerm(
            ...
            params={"asset_cfg": SceneEntityCfg("robot", body_names=_OBS_BODY_NAMES_2F140)},
        )
...
@configclass
class Ur5eRobotiq2f140RelCartesianOSCTrainCfg(Ur5eRobotiq2f140RlStateCfg):
...
@configclass
class Ur5eRobotiq2f140RelCartesianOSCFinetuneCfg(Ur5eRobotiq2f140RlStateCfg):
